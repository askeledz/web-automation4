...
public class MySqlLocalSelectTest extends BaseTest {

    private static final Logger logger = LogManager.getLogger(MySqlLocalSelectTest.class);
    ...
    @Parameters
    @Test(description = "MySQL Local SELECT Example", groups = {"checkintest"})
